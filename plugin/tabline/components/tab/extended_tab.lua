...
return {
    default_opts = {
        ...
        process_to_icon = {
            ['air'] = {
                wezterm.nerdfonts.md_language_go,
                color = {
                    fg = scheme.brights[5]
                }
            },
            ['apt'] = {
                wezterm.nerdfonts.dev_debian,
                color = {
                    fg = scheme.ansi[2]
                }
            },
            ['bacon'] = {
                wezterm.nerdfonts.dev_rust,
                color = {
                    fg = scheme.ansi[2]
                }
            },
            ['bash'] = {
                ...
                color = {
                    fg = scheme.cursor_bg or nil
                }
            },
            ['bat'] = {
                wezterm.nerdfonts.md_bat,
                color = {
                    fg = scheme.ansi[5]
                }
            },
            ['btm'] = {
                wezterm.nerdfonts.md_chart_donut_variant,
                color = {
                    fg = scheme.ansi[2]
                }
            },
            ['btop'] = {
                wezterm.nerdfonts.md_chart_areaspline,
                color = {
                    fg = scheme.ansi[2]
                }
            },
            ...
            ['bun'] = {
                wezterm.nerdfonts.md_hamburger,
                color = {
                    fg = scheme.cursor_bg or nil
                }
            },
            ...
            ['chezmoi'] = {
                wezterm.nerdfonts.md_home_plus_outline,
                color = {
                    fg = scheme.brights[5]
                }
            },
            ...
            ['fish'] = {
                wezterm.nerdfonts.md_fish,
                color = {
                    fg = scheme.cursor_bg or nil
                }
            },
            ['gh'] = {
                wezterm.nerdfonts.dev_github_badge,
                color = {
                    fg = scheme.indexed[16] or nil
                }
            },
            ['git'] = {
            ...
            ['npm'] = {
                wezterm.nerdfonts.md_npm,
                color = {
                    fg = scheme.brights[2]
                }
            },
            ['nvim'] = {
                wezterm.nerdfonts.custom_neovim,
                color = {
                    fg = scheme.ansi[3]
                }
            },
            ['pacman'] = {
                wezterm.nerdfonts.md_pac_man,
                color = {
                    fg = scheme.ansi[4]
                }
            },
            ...
            ['postgresql'] = {
                wezterm.nerdfonts.dev_postgresql,
                color = {
                    fg = scheme.ansi[5]
                }
            },
            ...
            ['rpm'] = {
                wezterm.nerdfonts.dev_redhat,
                color = {
                    fg = scheme.ansi[2]
                }
            },
            ['redis'] = {
                wezterm.nerdfonts.dev_redis,
                color = {
                    fg = scheme.ansi[5]
                }
            },
            ['ruby'] = {
                wezterm.nerdfonts.cod_ruby,
                color = {
                    fg = scheme.brights[2]
                }
            },
            ...
            ['topgrade'] = {
                wezterm.nerdfonts.md_rocket_launch,
                color = {
                    fg = scheme.ansi[5]
                }
            },
    ...
    update = function(tab, opts)
        ...
        if tab_title == '' then
            tab_title = foreground_process_name
        end
        return tab_title
    end
}
